...
## Must-read for new chats

1. [`../AGENTS.md`](../AGENTS.md)
2. [`context-handoff.md`](context-handoff.md)
...
- [`testing-stages.md`](testing-stages.md)
...
- [`prompts/project-prompts.md`](prompts/project-prompts.md)
- [`prompts/stage-prompts.md`](prompts/stage-prompts.md)

## Stage reports

- [`reports/stage-01-bootstrap.md`](reports/stage-01-bootstrap.md)
